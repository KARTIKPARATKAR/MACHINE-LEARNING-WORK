...
House Price Prediction is basically a Regression problem in which we have to predict the price of house based on availble supervised data.We have used different regression algorithms like **XGBoost,Linear-Regression,Ridge Regression,Lasso Regression,Decision Tress and Random Forest.** Evaluation result of all these algorithms can be seen -->.[here]()
